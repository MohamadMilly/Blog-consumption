...
export function SignUp() {
  ...
  return (
    <main className="relative w-full px-4 sm:px-12 py-4 my-6 max-w-190 mx-auto text-gray-200 transition-all duration-300">
      ...
      <h1 className="text-3xl tracking-tight mb-4 text-center">Sign up</h1>

      <form
        className="relative z-10 max-w-100 mx-auto mt-6 px-6 py-8 grid gap-4 bg-gray-900/40 backdrop-blur-md rounded-lg shadow-lg"
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <input
            className="px-4 py-2 rounded-full bg-gray-800/60 border border-gray-700 text-gray-100 placeholder-gray-400 focus:border-pink-500 focus:ring-2 focus:ring-pink-600 outline-none transition"
            type="text"
            required
            id="firstname"
            name="firstname"
        ...
        <button
          className="py-2 px-6 rounded-full bg-pink-700/80 hover:bg-pink-700/90 transition text-white font-semibold mt-2"
          type="submit"
        >
          Submit
        </button>
